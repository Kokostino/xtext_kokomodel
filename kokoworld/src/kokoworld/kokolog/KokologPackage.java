 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see kokoworld.kokolog.KokologFactory
 * @model kind="package"
 * @generated
 */
public interface KokologPackage extends EPackage {
	/**
	 * The package name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	String eNS_URI = "http://www.example.org/kokolog";
	 ...
	 * @generated
	 */
	KokologPackage eINSTANCE = kokoworld.kokolog.impl.KokologPackageImpl.init();

	/**
	 * The meta object id for the '{@link kokoworld.kokolog.impl.LogDocumentImpl <em>Log Document</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see kokoworld.kokolog.impl.LogDocumentImpl
	 * @see kokoworld.kokolog.impl.KokologPackageImpl#getLogDocument()
	 * @generated
	 */
	int LOG_DOCUMENT = 0;
	 ...
	 * @ordered
	 */
	int LOG_DOCUMENT__BASEENTITIES = KokoworldPackage.DOCUMENT_FEATURE_COUNT + 0;
	 ...
	 * @ordered
	 */
	int LOG_DOCUMENT_FEATURE_COUNT = KokoworldPackage.DOCUMENT_FEATURE_COUNT + 1;
	 ...
	 * @ordered
	 */
	int LOG_DOCUMENT_OPERATION_COUNT = KokoworldPackage.DOCUMENT_OPERATION_COUNT + 0;

	/**
	 * The meta object id for the '{@link kokoworld.kokolog.impl.BaseEntityImpl <em>Base Entity</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see kokoworld.kokolog.impl.BaseEntityImpl
	 * @see kokoworld.kokolog.impl.KokologPackageImpl#getBaseEntity()
	 * @generated
	 */
	int BASE_ENTITY = 1;
	 ...
	 * @ordered
	 */
	int BASE_ENTITY__LOGDOCUMENT = 0;
	 ...
	 * @see kokoworld.kokolog.LogDocument
	 * @generated
	 */
	EClass getLogDocument();

	/**
	 * Returns the meta object for the containment reference list '{@link kokoworld.kokolog.LogDocument#getBaseentities <em>Baseentities</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for class '{@link kokoworld.kokolog.BaseEntity <em>Base Entity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Base Entity</em>'.
	 * @see kokoworld.kokolog.BaseEntity
	 * @generated
	 */
	EClass getBaseEntity();

	/**
	 * Returns the meta object for the container reference '{@link kokoworld.kokolog.BaseEntity#getLogdocument <em>Logdocument</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	...
	/**
	 * Returns the meta object for the attribute '{@link kokoworld.kokolog.BaseEntity#getName <em>Name</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Name</em>'.
	 * @see kokoworld.kokolog.BaseEntity#getName()
	 * @see #getBaseEntity()
	 * @generated
	 */
	 ...
	 * @generated
	 */
	KokologFactory getKokologFactory();
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link kokoworld.kokolog.impl.LogDocumentImpl <em>Log Document</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see kokoworld.kokolog.impl.LogDocumentImpl
		 * @see kokoworld.kokolog.impl.KokologPackageImpl#getLogDocument()
		...
		/**
		 * The meta object literal for the '{@link kokoworld.kokolog.impl.BaseEntityImpl <em>Base Entity</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see kokoworld.kokolog.impl.BaseEntityImpl
		 * @see kokoworld.kokolog.impl.KokologPackageImpl#getBaseEntity()
