 ...
 * </p>
 * <ul>
 *   <li>{@link kokoworld.kokoworld.impl.ImportImpl#getItem <em>Item</em>}</li>
 *   <li>{@link kokoworld.kokoworld.impl.ImportImpl#getImportcontainer <em>Importcontainer</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportImpl extends MinimalEObjectImpl.Container implements Import {
	...
	public ImportContainer getImportcontainer() {
		if (eContainerFeatureID() != KokoworldPackage.IMPORT__IMPORTCONTAINER) return null;
	...
	public void setImportcontainer(ImportContainer newImportcontainer) {
		if (newImportcontainer != eInternalContainer() || (eContainerFeatureID() != KokoworldPackage.IMPORT__IMPORTCONTAINER && newImportcontainer != null)) {
			...
			if (newImportcontainer != null)
				msgs = ((InternalEObject)newImportcontainer).eInverseAdd(this, KokoworldPackage.IMPORT_CONTAINER__IMPORTS, ImportContainer.class, msgs);
			msgs = basicSetImportcontainer(newImportcontainer, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KokoworldPackage.IMPORT__IMPORTCONTAINER, newImportcontainer, newImportcontainer));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case KokoworldPackage.IMPORT__IMPORTCONTAINER:
				return eInternalContainer().eInverseRemove(this, KokoworldPackage.IMPORT_CONTAINER__IMPORTS, ImportContainer.class, msgs);
		}
