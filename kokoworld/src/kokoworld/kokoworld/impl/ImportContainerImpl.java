 ...
 * </p>
 * <ul>
 *   <li>{@link kokoworld.kokoworld.impl.ImportContainerImpl#getImports <em>Imports</em>}</li>
 *   <li>{@link kokoworld.kokoworld.impl.ImportContainerImpl#getDocument <em>Document</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ImportContainerImpl extends MinimalEObjectImpl.Container implements ImportContainer {
	...
	public EList<Import> getImports() {
		if (imports == null) {
			imports = new EObjectContainmentWithInverseEList<Import>(Import.class, this, KokoworldPackage.IMPORT_CONTAINER__IMPORTS, KokoworldPackage.IMPORT__IMPORTCONTAINER);
		}
		return imports;
	}
	...
	public Document getDocument() {
		if (eContainerFeatureID() != KokoworldPackage.IMPORT_CONTAINER__DOCUMENT) return null;
	...
	public void setDocument(Document newDocument) {
		if (newDocument != eInternalContainer() || (eContainerFeatureID() != KokoworldPackage.IMPORT_CONTAINER__DOCUMENT && newDocument != null)) {
			...
			if (newDocument != null)
				msgs = ((InternalEObject)newDocument).eInverseAdd(this, KokoworldPackage.DOCUMENT__IMPORTCONTAINER, Document.class, msgs);
			msgs = basicSetDocument(newDocument, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KokoworldPackage.IMPORT_CONTAINER__DOCUMENT, newDocument, newDocument));
	}
	...
	public NotificationChain eBasicRemoveFromContainerFeature(NotificationChain msgs) {
		switch (eContainerFeatureID()) {
			case KokoworldPackage.IMPORT_CONTAINER__DOCUMENT:
				return eInternalContainer().eInverseRemove(this, KokoworldPackage.DOCUMENT__IMPORTCONTAINER, Document.class, msgs);
		}
