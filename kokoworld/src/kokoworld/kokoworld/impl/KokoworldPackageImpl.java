...
import kokoworld.kokolog.impl.KokologPackageImpl;

import kokoworld.kokoworld.Document;
import kokoworld.kokoworld.IDescribable;
import kokoworld.kokoworld.INamedElement;
import kokoworld.kokoworld.Import;
import kokoworld.kokoworld.ImportContainer;
import kokoworld.kokoworld.KokoworldFactory;
...
public class KokoworldPackageImpl extends EPackageImpl implements KokoworldPackage {
	 ...
	 * @see kokoworld.kokoworld.KokoworldPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static KokoworldPackage init() {
		if (isInited) return (KokoworldPackage)EPackage.Registry.INSTANCE.getEPackage(KokoworldPackage.eNS_URI);

		// Obtain or create and register package
		Object registeredKokoworldPackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		KokoworldPackageImpl theKokoworldPackage = registeredKokoworldPackage instanceof KokoworldPackageImpl ? (KokoworldPackageImpl)registeredKokoworldPackage : new KokoworldPackageImpl();

		isInited = true;

		// Obtain or create and register interdependencies
		Object registeredPackage = EPackage.Registry.INSTANCE.getEPackage(KokologPackage.eNS_URI);
		KokologPackageImpl theKokologPackage = (KokologPackageImpl)(registeredPackage instanceof KokologPackageImpl ? registeredPackage : KokologPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		initEReference(getDocument_Members(), this.getMember(), null, "members", null, 0, -1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getDocument_Importcontainer(), this.getImportContainer(), this.getImportContainer_Document(), "importcontainer", null, 0, 1, Document.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImportContainer_Imports(), this.getImport(), this.getImport_Importcontainer(), "imports", null, 0, -1, ImportContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getImportContainer_Document(), this.getDocument(), this.getDocument_Importcontainer(), "document", null, 0, 1, ImportContainer.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getImport_Importcontainer(), this.getImportContainer(), this.getImportContainer_Imports(), "importcontainer", null, 0, 1, Import.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
