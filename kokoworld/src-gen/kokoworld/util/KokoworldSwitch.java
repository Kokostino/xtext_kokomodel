 ...
 * @generated
 */
public class KokoworldSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case KokoworldPackage.MEMBER: {
			Member member = (Member) theEObject;
			T result = caseMember(member);
			if (result == null)
				result = caseINamedElement(member);
			if (result == null)
				result = caseIDescribable(member);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case KokoworldPackage.INAMED_ELEMENT: {
		...
		case KokoworldPackage.IDESCRIBABLE: {
