 ...
 * </p>
 * <ul>
 *   <li>{@link kokoworld.impl.BaseEntityImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class BaseEntityImpl extends MinimalEObjectImpl.Container implements BaseEntity {
	...
	protected EClass eStaticClass() {
		return KokoworldPackage.Literals.BASE_ENTITY;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, KokoworldPackage.BASE_ENTITY__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case KokoworldPackage.BASE_ENTITY__NAME:
			return getName();
		}
