 ...
 * </p>
 * <ul>
 *   <li>{@link kokoworld.impl.DocumentImpl#getName <em>Name</em>}</li>
 *   <li>{@link kokoworld.impl.DocumentImpl#getMembers <em>Members</em>}</li>
 *   <li>{@link kokoworld.impl.DocumentImpl#getImportcontainer <em>Importcontainer</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class DocumentImpl extends MinimalEObjectImpl.Container implements Document {
	...
	public NotificationChain basicSetImportcontainer(ImportContainer newImportcontainer, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					KokoworldPackage.DOCUMENT__IMPORTCONTAINER, oldImportcontainer, newImportcontainer);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newImportcontainer != importcontainer) {
			...
			if (importcontainer != null)
				msgs = ((InternalEObject) importcontainer).eInverseRemove(this,
						KokoworldPackage.IMPORT_CONTAINER__DOCUMENT, ImportContainer.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET, KokoworldPackage.DOCUMENT__IMPORTCONTAINER,
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		...
		case KokoworldPackage.DOCUMENT__IMPORTCONTAINER:
			if (importcontainer != null)
				msgs = ((InternalEObject) importcontainer).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - KokoworldPackage.DOCUMENT__IMPORTCONTAINER, null, msgs);
