...
public class LogDslSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	protected void sequence_BaseEntity(ISerializationContext context, BaseEntity semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, KokologPackage.Literals.BASE_ENTITY__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, KokologPackage.Literals.BASE_ENTITY__NAME));
		}
	 ...
	 *
	 * Constraint:
	 *     (name=QName baseentities+=BaseEntity)
	 */
